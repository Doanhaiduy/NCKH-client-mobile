...
export default function FinishedEventList() {
    return (
        <ScrollView
            style={{
                flex: 1,
        ...
        >
            <SectionComponent className="flex-1">
                <TextComponent text="Đã diễn ra" className="text-[20px] text-primary-500 font-interMd mt-2 mb-4" />
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <ItemCardGrid
                                ...
                                onPress={() => {
                                    router.push({
                                        pathname: `/finished-events/details/${item.id}`,
                                        params: {
