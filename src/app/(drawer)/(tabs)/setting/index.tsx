    ...
    return (
        <ContainerComponent isScroll title='Cài đặt' iconLeft='menu' search>
            ...
            <SectionComponent className='mt-4'>
                <TouchableOpacity className='flex-row flex-1 items-center py-6 border-y-[1px] border-y-text-500'>
                ...
                <TouchableOpacity className='flex-row flex-1 items-center py-6 border-b-[1px] border-b-text-500'>
